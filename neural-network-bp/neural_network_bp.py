...
class Network:
    ...
    def feed_forward(self, data_point):
        ...
        self.hidden_layer_activation = np.matmul(self.input_layer_activation, self.input_hidden_weights) + self.hidden_layer_bias
        self.output_layer_activation = np.matmul(self.hidden_layer_activation, self.hidden_output_weights) + self.output_layer_bias
